    ...
    return (
      <div>
        <Container>
          ...
          <Row>
            <Col xs='3'>
              <CategoryList currentCategory={this.state.currentCategory} changeCategory={this.changeCategory} title={titleCategory} categories={this.state.categories} getCategories={this.getCategories}/>
            </Col>
            <Col xs='9'>
              <Routes>
                ...
                <Route path='SetCategory' element={<SetCategory categories={this.state.categories}/>}/>
                <Route path='SetProduct' element={<SetProduct categories={this.state.categories} products={this.state.products} />}/>
